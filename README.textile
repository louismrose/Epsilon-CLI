...
A simple command-line interface for Epsilon. Run using:

@java -jar epsilon_cli.jar@

The following mandatory command-line arguments must be specified:

@--mma <pathToMetamodelA> --mmb <pathToMetamodelB> --transf <pathToEpsilonProgram> --ma <pathToModelA> --mb <pathToModelB> --log <pathToModelB>@
