...
public class EtlCliTest extends CliThatRunsToCompletionTest {

	@Override
	protected File getProgram() {
		return getNearbyFile("Lowercase.etl", EtlCliTest.class);
	}
	...
	@Test
	public void targetShouldContainNodesWithLowercasedNames() throws Throwable {
		...
		for (String originalName : originalNames) {
			final String lowercasedName = originalName.toLowerCase();
			target.assertTrue("Node.all.exists(n|n.name = '" + lowercasedName + "')");
		}		
	}
}
